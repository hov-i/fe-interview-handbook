...
> 신입 면접에서 거의 반드시 나오는 단골 질문입니다. 정확하게 답변할 수 있어야 합니다.
...
예를 들어, 다음과 같은 코드에서 클로저를 확인할 수 있습니다:
...
<details>
<summary>자바스크립트에서 this는 어떻게 결정되나요?</summary>
...
> 심화 질문이거나 특정 회사에서 깊게 물어보는 질문입니다. 알면 차별화 포인트가 됩니다.
...
<details>
<summary>함수 선언문과 함수 표현식의 호이스팅 동작 차이는 무엇인가요?</summary>
...
<details>
<summary>JSX가 뭐고, 자바스크립트에서 어떻게 변환되나요?</summary>
...
<details>
<summary>SSR(서버 사이드 렌더링)과 CSR(클라이언트 사이드 렌더링)의 차이는?</summary>
...
<details>
<summary>Controlled 패턴과 Uncontrolled 패턴을 함께 사용하는 경우는 있나요?</summary>
...
<details>
<summary>React에서 useRef는 어떤 용도로 사용하나요?</summary>
...
<details>
<summary>uncontrolled pattern에 대해 알고 있나요?</summary>
...
<details>
<summary>거대 폼을 확장가능하게 구현하셨다고 하셨는데 일반 폼 설계/구현과 다른 점이 있었던건가요?</summary>
...
<details>
<summary>레이아웃과 레이아웃을 사용하는 여러 개의 애플리케이션을 각각 별도로 개발한다고 했을 때 어떻게 해야 유저에게 하나의 애플리케이션으로 서빙할 수 있을까요?</summary>
...
<details>
<summary>상태 변화에 따라 렌더링을 제어할 수 있는데 렌더 할 배열 상태를 굳이 렌더큐와 백그라운드큐로 분리한 이유가 뭔가요?</summary>
...
<details>
<summary>FSD 아키텍처란 무엇인가요?</summary>
...
<details>
<summary>CSS의 box-sizing 속성은 무엇인가요?</summary>
...
<details>
<summary>대킹 키와 비대칭 키의 차이가 무엇인가요?</summary>
...
<details>
<summary>XSS(크로스 사이트 스크립팅)란 무엇이고 어떻게 방어하나요?</summary>
...
<details>
<summary>CSP(Content Security Policy)란 무엇인가요?</summary>
...
<details>
<summary>웹 스토리지(localStorage, sessionStorage)와 쿠키의 차이는?</summary>
...
<details>
<summary>async와 defer 속성의 차이는 무엇인가요?</summary>
...
<details>
<summary>비대칭키(공개키/개인키) 암호화란 뭔가요?</summary>
...
<details>
<summary>TLS 핸드셰이크 과정에서 대칭키와 비대칭키는 어떻게 함께 사용되나요?</summary>
...
<details>
<summary>큐와 스택의 차이는 무엇인가요?</summary>
...
<details>
<summary>해시 테이블이란 무엇인가요?</summary>
...
<details>
<summary>연결 리스트(Linked List)와 배열 기반 리스트의 차이는 무엇인가요?</summary>
...
<details>
<summary>이진 탐색 트리(BST)의 시간 복잡도는 항상 O(log n)인가요?</summary>
...
<details>
<summary>모듈 번들러란 뭔가요? 왜 필요한가요?</summary>
...
<details>
<summary>Webpack과 Vite의 장단점을 비교하면 어떤 차이가 있나요?</summary>
...
<details>
<summary>Webpack의 번들링 과정은 어떻게 이루어지나요?</summary>
...
<details>
<summary>Vite에서 pre-bundling은 왜 필요한가요? 어떤 문제를 해결하기 위한 과정인가요?</summary>
...
<details>
<summary>결제 모듈을 리팩토링 하면서 굉장히 조심스러웠을텐데요. 어떻게 문제 없음을 보장했나요?</summary>
...
<details>
<summary>구글 광고처럼 비슷하지만 노출 지면에서 조금씩 다른 UI를 구현한다면 어떻게 하면 좋을까요?</summary>
...
<details>
<summary>모노리스를 분리하면서 얻은 것도 있지만 잃은 것도 있을 것 같아요. 어떤 점이었나요? 어떻게 보완했나요?</summary>
...
<details>
<summary>모바일과 데스크탑에 동일한 서비스를 최소 비용으로 개발하고 운영하고자 해요. 어떻게 하는게 좋을까요?</summary>
...
- [Frontend-Interview-Questions](https://github.com/Esoolgnah/Frontend-Interview-Questions) - 프론트엔드 중요도별 면접질문 + 용어 설명
- [kr-frontend-kit](https://kr-frontend-kit.vercel.app/) - 프론트엔드 면접 준비 키트
